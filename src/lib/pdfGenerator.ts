  ...
  sortedLocationIds.forEach(locationId => {
      ...
      locationHtml += `
       <div style="margin-bottom: 20px;">
        <div style="display: flex; align-items: center; margin-bottom: 8px; min-height: 22px;">
          ...
          <div style="font-size: 14px; font-weight: 800; text-transform: uppercase; letter-spacing: 1.5px; margin: 0; padding: 0; height: 20px; line-height: 20px; display: flex; align-items: center; position: relative; top: -1px;">
            ${categoryName}
          </div>
        </div>
    ...
    const locationHeaderHtml = isNoLocation
      ...
      : `<div style="display: flex; align-items: center; gap: 10px; margin-bottom: 12px; min-height: 22px;">
          ...
          <div style="padding: 0 10px; height: 20px; line-height: 20px; border-radius: 9999px; font-size: 10px; font-weight: 800; letter-spacing: 1px; text-transform: uppercase; color: #f3f4f6; background: ${locationAccent}; display: flex; align-items: center; position: relative; top: -1px;">
            ${locationName}
          </div>
        </div>`;
