  ...
  const footerTotalsHtml = isCombinedOnlyMode
    ? `
      <div style="display: flex; justify-content: flex-end; align-items: center; gap: 8px; width: 100%;">
        ...
        <span style="font-size: 32px; font-weight: 700; line-height: 1.2; text-align: right; position: relative; top -16px; white-space: nowrap; color: #000000;">${formatMoney(pdfCombinedTotal)}${currencySuffix}</span>
      </div>
      ...
      <div style="display: flex; justify-content: flex-end; align-items: center; gap: 8px; width: 100%;">
        ...
        <span style="font-size: 32px; font-weight: 700; line-height: 1.2; color: #000000; text-align: right; position: relative; top -16px; white-space: nowrap;">${formatMoney(editorDiscountedTotal)}${currencySuffix}</span>
      </div>` : ''}
    `
    : `
      <div style="display: flex; justify-content: flex-end; align-items: center; gap: 8px; width: 100%;">
        ...
        <span style="font-size: 32px; font-weight: 700; line-height: 1.2; text-align: right; position: relative; top -16px; white-space: nowrap; color: #000000;">${formatMoney(pdfDay1Total)}${currencySuffix}</span>
      </div>
      ${budgetDays > 1 ? `
      <div style="display: flex; justify-content: flex-end; align-items: center; gap: 8px; width: 100%;">
