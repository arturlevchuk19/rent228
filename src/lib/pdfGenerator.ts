      ...
      <div style="display: flex; flex-direction: column; gap: 6px;">
        ...
        <div style="display: flex; gap: 15px; align-items: center;">
          <span style="display: flex; align-items: center; color: #9ca3af; font-size: 10px;">
            <svg style="width: 14px; height: 14px; margin-right: 5px; fill: currentColor; display: block; position: relative; top: 1px;" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>
            <span style="line-height: 1;">onpromo.by</span>
          </span>
          <span style="display: flex; align-items: center; color: #9ca3af; font-size: 10px;">
            <svg style="width: 14px; height: 14px; margin-right: 5px; fill: currentColor; display: block; position: relative; top: 1px;" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771
